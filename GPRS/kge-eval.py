...
# Step 2: Select a representative subset of items
# Assuming you have already loaded your data into a list called 'items'
subset_size = 1000
subset_items = items[:subset_size]

# Step 3: Split the evaluation dataset
train_ratio = 0.8
train_size = int(train_ratio * subset_size)
train_items = subset_items[:train_size]
test_items = subset_items[train_size:]
